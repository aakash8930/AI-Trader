...
class LiveSettings:
    ...
    min_model_val_precision: float = 0.35
    min_model_val_recall: float = 0.30
    ...
    def from_env(cls) -> "LiveSettings":
        ...
        return cls(
            ...
            min_model_val_precision=_env_float("MIN_MODEL_VAL_PRECISION", 0.35),
            min_model_val_recall=_env_float("MIN_MODEL_VAL_RECALL", 0.30),
